...
class Search():
    ...
    def __init__(self, name):
        ...
        # Set place holders for sailor actual location
        self.area_actual = 0
    ...
    def draw_map(self, last_known):
        """Display basemap with scale, last known xy location, search area."""
        ...
        cv.rectangle(self.img, (SA1_CORNERS[0], SA1_CORNERS[1]),
                                (SA1_CORNERS[2], SA1_CORNERS[3]), (0, 0, 0))
        ...
        cv.rectangle(self.img,(SA2_CORNERS[0], SA2_CORNERS[1]),
                            (SA2_CORNERS[2], SA2_CORNERS[3]), (0, 0, 0))
        ...
        cv.rectangle(self.img,(SA3_CORNERS[0], SA3_CORNERS[1]),
                            (SA3_CORNERS[2], SA3_CORNERS[3]), (0, 0, 0))
    ...
    def sailor_final_location(self, num_search_areas):
        ...
        # Find sailor coordinates with respect to anySearch Area subarray.
...
def main():
    ...
    while True:
        ...
        if choice == "0":
            ...
            print("\nSorry, but you are an idiot.", file=sys.stderr)
            continue
